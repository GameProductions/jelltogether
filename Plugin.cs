...
using JellyParty.Plugin.Configuration;

namespace JellyParty.Plugin
{
    public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
    {
        public override string Name => "JellyParty";
        ...
        public IEnumerable<PluginPageInfo> GetPages()
        {
            return new[]
            {
                ...
                {
                    Name = "jellyparty",
                    EmbeddedResourcePath = GetType().Namespace + ".Web.jellyparty.html"
                }
            };
        }
    }
